    ...
    <div className='mainDiv'>
      <div className='maindivInside'>
        ...
        <div className='chart1 '>
            <h1 className='text-white p-7 text-start py-5 font-normal text-2xl'>Bookings</h1>
        ...
        <div className='chart2 '>
            <img className='w-full h-full rounded-3xl' alt='graph ' src='https://www.tableau.com/sites/default/files/2021-09/Line%20Chart%201%20-%20Good%20-%20900x650.png'/>
        </div>
