  ...
  return (
    <div className='sidenavBase'>
        ...
        <div className='profileSection text-center'>
            <div className='flex justify-center'>
                <div className='profilePhoto'>
                    <img src='https://buffer.com/library/content/images/2020/05/Ash-Read.png' alt='profilePhoto'/>
                </div>
            </div>
            <div>
        ...
        <div className='text-center grid py-16'>
            <button onClick={logoutAdmin} className='text-slate-500'>Logout</button>
        </div>
